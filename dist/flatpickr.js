        ...
        if (e.keyCode === 13 && isInput) {
          ...
          switch (e.keyCode) {
            ...
            case 40:
              ...
              if ( !isTimeObj && self.daysContainer !== undefined && (allowInput === false || isInView(document.activeElement))) {
                var _delta = e.keyCode === 40 ? 1 : -1;

                if (!e.ctrlKey) focusOnDay(undefined, _delta * 7);else {
                  changeMonth(_delta);
                  focusOnDay(getFirstAvailableDay(1), 0);
                }
              } else if (self.daysContainer && e.target.$i !== undefined) {
                if (e.ctrlKey) {
